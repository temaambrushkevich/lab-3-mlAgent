...
## Задание 2
### Подробное описание каждой строки файла конфигурации нейронной сети. Самостоятельно нашёл информацию о компонентах Decision Requester, Behavior Parameters, добавленных на сфере. 
...
## Задание 3
### Доработал сцену и обучил ML-Agent таким образом, чтобы шар перемещался между двумя кубами разного цвета. Кубы, как и в первом задании, случайно изменяли координаты на плоскости.
